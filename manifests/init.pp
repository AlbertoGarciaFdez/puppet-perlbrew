class perlbrew (
  ...
  if ($bundle != 'false') {
    ...
    exec { 'install_bundle':
      command => "bin/su ${perlbrew::user} -c - \"source /home/${perlbrew::user}/perl5/perlbrew/etc/bashrc; /home/${perlbrew::user}/perl5/perlbrew/perls/perl-${perl_use}/bin/perl -MCPAN -e 'install Bundle::bundle'\"",
      timeout => '0',
    }
  }
}
